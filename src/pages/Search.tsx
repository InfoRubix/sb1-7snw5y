...
function SearchResult({ file }: SearchResultProps) {
  const sendWhatsAppMessage = () => {
    const message = encodeURIComponent(
      ...
      `Loan Amount: ${formatCurrency(file.loanDetails.amount)}\n\n` +
      `Please contact us if you need any clarification.`
    );
    
    window.open(`https://wa.me/${file.stakeholders[0].contact.phone}?text=${message}`, '_blank');
  };
